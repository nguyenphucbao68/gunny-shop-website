...
// //     widthObject: 130,
// //     heightObject: 162,
// //     imageloaded: {equip: {}, overlay: {}, screenshot: {}, screenshotSkin: {}, skin: {}},
// //     setPath: function(){
// //         infoCurrent.setChar();
// //         for (var key in ctxProperties.suit) {
// //             this.res[key] = this.res[key] || {};
// //             var suitKey = ctxProperties.suit[key] || 0;
// //             if (key == 'hair') {
// //                 if (suitKey == 0) {
// //                     // set default cho tóc, theo dạng 1 tóc
// //                     this.res[key].original = infoConfig.host + 'equip/' + infoCurrent.pathChar + '/' + key + '/default/1/B/show.png'
// //                     this.res[key].overlay = infoConfig.host + 'equip/' + infoCurrent.pathChar + '/' + key + '/default/2/B/show.png'
// //                 } else {
// //                     // Kiem tra co head (mũ) hay chưa. Nếu có ta xài object 1/2 tóc
// //                     var char = (ctxProperties.suit.head != 0 && ctxProperties.hide.head == 0) ? 'A' : 'B' // A là có nón
// //                     this.res[key].original = infoConfig.host + 'equip/' + infoCurrent.pathChar + '/' + key + '/' + suitKey + '/1/' + char + '/show.png'
// //                     this.res[key].overlay = infoConfig.host + 'equip/' + infoCurrent.pathChar + '/' + key + '/' + suitKey + '/2/' + char + '/show.png'
// //                 }
...
// //                 this.res[key].original = infoConfig.host + 'equip/' + infoCurrent.pathChar + '/' + key + '/default/1/show.png'
// //                 this.res[key].overlay = infoConfig.host + 'equip/' + infoCurrent.pathChar + '/' + key + '/default/3/show.png'
// //             } else if (key == 'cloth' || key == 'face') {
// //                 // nếu là áo và mặt ta chạy path 1 và 3
// //                 this.res[key].original = infoConfig.host + 'equip/' + infoCurrent.pathChar + '/' + key + '/' + suitKey + '/1/show.png'
// //                 this.res[key].overlay = infoConfig.host + 'equip/' + infoCurrent.pathChar + '/' + key + '/' + suitKey + '/3/show.png'
// //             } else if (suitKey != 0) {
// //                 // như bình thường (ko nằm trong mấy trường hợp trên) ta set như sau
// //                 this.res[key].original = infoConfig.host + 'equip/' + infoCurrent.pathChar + '/' + key + '/' + suitKey + '/1/show.png'
// //                 this.res[key].overlay = infoConfig.host + 'equip/' + infoCurrent.pathChar + '/' + key + '/' + suitKey + '/2/show.png'
// //                 if (key == 'head' && ctxProperties.hide.head == 0) {
// //                     var pic = (ctxProperties.suit.hair == 0) ? 'default' : ctxProperties.suit.hair
// //                     this.res.hair.original = infoConfig.host + 'equip/' + infoCurrent.pathChar + '/hair/' + pic + '/1/A/show.png'
// //                     this.res.hair.overlay = infoConfig.host + 'equip/' + infoCurrent.pathChar + '/hair/' + pic + '/2/A/show.png'
// //                 }
// //             }
// //         };
// //         this.res.face = this.res.face || {};
// //         this.res.face.skin = infoConfig.host + 'equip/' + infoCurrent.pathChar + '/face/' + (ctxProperties.suit.face == 0 ? 'default' : ctxProperties.suit.face) + '/2/show.png'
// //         this.res.cloth = this.res.cloth || {};
// //         this.res.cloth.skin = infoConfig.host + 'equip/' + infoCurrent.pathChar + '/cloth/' + (ctxProperties.suit.cloth == 0 ? 'default' : ctxProperties.suit.cloth) + '/2/show.png'
// //     },
// //     loadObject: function(key){
// //         if(this.imageloaded.equip[key] && this.res[key].overlay){  
// //             ctxProperties.clear(key);
// //             if(this.imageloaded.overlay[key]){
// //                 let resObjectData = {
// //                     key: key,
// //                     overlay: this.imageloaded.overlay[key],
...
// //                 };
// //                 if(key === 'face'){
// //                     objectRun.drawFace("faceColor", resObjectData)
// //                 }else{
// //                     draw.drawStaticObjectColor(resObjectData)
// //                 }
                
// //             }else{
// //                 var that = this;
// //                 this.imageloaded.overlay[key] = new Image;
// //                 this.imageloaded.overlay[key].src = this.res[key].overlay;
// //                 this.imageloaded.overlay[key].original = this.imageloaded.equip[key];
// //                 this.imageloaded.overlay[key].key = key;
// //                 this.imageloaded.overlay[key].onload = function(){
// //                     let resObjectData = {
// //                         key: this.key,
// //                         overlay: this,
...
// //             }
// //         }else{  
// //             console.log("You must run the avatarGunny.load() method before running this function");
// //             return;
// //         }
// //     },
// //     load: function(){
// //         // alert('test');
// //         this.setPath();
// //         ctxProperties.clearAll();
// //         var that = this;
// //         for(var key in this.res){
// //             this.imageloaded.equip[key] = new Image;
// //             this.imageloaded.equip[key].src = this.res[key].original;
// //             this.imageloaded.equip[key].key = key;
// //             this.imageloaded.equip[key].onload = function(){
// //                 if(this.key == "face") return;
// //                 if(ctxProperties.color[this.key] == 0){
// //                     draw.drawStaticObject({
// //                         key: this.key,
// //                         original: this,
// //                         dWidth: that.widthObject,
// //                         dHeight: that.heightObject,
...
// //                         dy: that.y
// //                     });
// //                 } else if (this.key in ctxProperties.color && ctxProperties.color[this.key] != 0) {
// //                     that.imageloaded.overlay[this.key] = new Image;
// //                     that.imageloaded.overlay[this.key].src = that.res[this.key].overlay;
// //                     that.imageloaded.overlay[this.key].original = this;
// //                     that.imageloaded.overlay[this.key].key = this.key;
// //                     that.imageloaded.overlay[this.key].onload = function () {
// //                         draw.drawStaticObjectColor({
// //                             key: this.key,
// //                             overlay: this,
// //                             original: this.original,
// //                             dWidth: that.widthObject,
...
// //         this.loadSkin();
// //     },
// //     loadFaceAnimation: function(key = 'face'){
// //         // Draw face;
// //         var that = this;
// //         if (!ctxProperties.color[key]) {
// //             this.imageloaded.equip[key] = new Image;
// //             this.imageloaded.equip[key].src = this.res[key].original;
// //             this.imageloaded.equip[key].onload = function () { 
// //                 objectRun.drawFace("faceOrignal", {
// //                     key: key,
// //                     original: this,
// //                     dWidth: that.widthObject,
// //                     dHeight: that.heightObject,
...
// //             //     objectRun.drawFace("faceSkinColor", {
// //             //         ctx: ctxProperties.val["face"],
// //             //         hex: ctxProperties.skinColor,
// //             //         skin: this,
// //             //         original: this.original,
// //             //         dWidth: 130,
// //             //         dHeight: 162,
...
// //         }
// //     },
// //     resetDefaultObject: function(key){
// //         ctxProperties.suit[key] = 0;
// //     },
// //     resetAllObject: function(key){
// //         for(var key in ctxProperties.suit){
// //             ctxProperties.suit[key] = 0;
// //         }
// //     },
// //     resetColor: function(key){
// //         ctxProperties.color[key] = 0;
// //     },
// //     setColor: function(key, hex){
// //         ctxProperties.color[key] = hex;
// //     },
// //     setAllObject: function(value){
// //         ctxProperties.suit = value;
// //     },
// //     setObject: function(key, pic){
// //         ctxProperties.suit[key] = pic;
// //     }
// // }
...
// //     stopInterval: false,
// //     drawType: {
// //         faceOrignal: function(data, srcX, srcY){
// //             ctxProperties.clear(data.key);
// //             ctxProperties.val[data.key].drawImage(data.original, srcX, srcY, this.objectRun.widthOnceFrame, this.objectRun.heightOnceFrame, data.dx, data.dy, data.dWidth, data.dHeight)
// //         },
// //         faceColor: function(data, srcX, srcY, count){
// //             ctxProperties.clear(data.key);
// //             ctxProperties.val[data.key].drawImage(data.overlay, srcX, srcY, this.objectRun.widthOnceFrame, this.objectRun.heightOnceFrame, data.dx, data.dy, data.dWidth, data.dHeight)
// //             ctxProperties.val[data.key].globalCompositeOperation = 'source-atop';
// //             ctxProperties.val[data.key].fillStyle = ctxProperties.color[data.key];
// //             ctxProperties.fill(data.key);
// //             ctxProperties.val[data.key].globalCompositeOperation = 'luminosity';
// //             ctxProperties.val[data.key].drawImage(data.original, srcX, srcY, this.objectRun.widthOnceFrame, this.objectRun.heightOnceFrame, data.dx, data.dy, data.dWidth, data.dHeight)
// //         },
// //         faceSkinColor: function(data, srcX, srcY, count){

// //         }
// //     },
// //     drawFace: function(typeName, data){
// //         this.reset();
// //         // this.interval[typeName] = this.interval[typeName] || false;
        
// //         this.interval[typeName] = setInterval(() => {
// //             if(this.stopInterval) return;
// //             this.cEAction++;
// //             switch(true){
// //                 case (this.cEAction == 1 || this.cEAction == 5):
// //                     eval(this.drawType[typeName])(data, 0, 0, '0');
// //                     break;
// //                 case (this.cEAction == 2 || this.cEAction == 4):
// //                     eval(this.drawType[typeName])(data, 750, 0, '1');
// //                     break;
// //                 case this.cEAction == 3:
// //                     eval(this.drawType[typeName])(data, 500, 0, '2');
// //                     this.cEClose++;
// //                     break;
...
// // var draw = {
// //     drawStaticObjectSkin: function(data){
// //         ctxProperties.clear(data.key);
// //         ctxProperties.val[data.key].drawImage(data.skin, data.dx, data.dy, data.dWidth, data.dHeight);
// //         ctxProperties.val[data.key].globalCompositeOperation = 'source-atop';
// //         ctxProperties.val[data.key].fillStyle = ctxProperties.skinColor;
// //         ctxProperties.fill(data.key);
// //         ctxProperties.val[data.key].globalCompositeOperation = 'luminosity';
// //         var imageDoc = new Image;
// //         imageDoc.src = ctxProperties.doc[data.key].toDataURL();
// //         imageDoc.onload = function () {
// //             avatarGunny.imageloaded.screenshotSkin[data.key] = this;
// //         }
// //         if (ctxProperties.color[data.key] != 0) {
// //             ctxProperties.val[data.key].drawImage(avatarGunny.imageloaded.screenshot[data.key], 0, 0);
// //         } else {
// //             ctxProperties.val[data.key].drawImage(data.original, data.dx, data.dy, data.dWidth, data.dHeight);
// //         }
// //     },
// //     drawStaticObjectColor: function(data){
// //         // ctx, original, overlay, hex, x, y, widthObject, heightObject
// //         ctxProperties.clear(data.key);
// //         ctxProperties.val[data.key].drawImage(data.overlay, data.dx, data.dy, data.dWidth, data.dHeight);
// //         ctxProperties.val[data.key].globalCompositeOperation = 'source-atop';
// //         ctxProperties.val[data.key].fillStyle = ctxProperties.color[data.key];
// //         ctxProperties.fill(data.key);
// //         ctxProperties.val[data.key].globalCompositeOperation = 'luminosity';
...
// //     //     item_equip[key] = new Image()
// //     //     item_equip[key].src = resSuit[key]['original']
// //     //     item_equip[key].key = key
// //     //     item_equip[key].onload = function () {
// //     //         if (this.key == 'face') return
// //     //         if (suitColor[this.key] == 0) {
// //     //             ctx[this.key].drawImage(this, 23, 25, 130, 162)
// //     //         } else if (this.key in suitColor && suitColor[this.key] != 0) {
// //     //             overlay2 = new Image()
// //     //             overlay2.src = resSuit[this.key]['overlay']
// //     //             overlay2.ctx = ctx[this.key]
// //     //             overlay2.item = item_equip[this.key]
// //     //             overlay2.color = suitColor[this.key]
...
// //     //         drawEMatAnimation(ctx['face'], this, item_equip['face'], suitColor['face'], 'face')
// //     //     }
// //     // } else {
// //     //     var img2 = new Image()
...
// //     //     skin.item = item_equip['cloth']
// //     //     skin.ctx = ctx['cloth']
// //     //     skin.onload = function () {
// //     //         drawSkinColor(this.ctx, this.item, this, colorSkin, 'cloth')
// //     //     }
// //     //     skin = new Image()
// //     //     skin.src = resSuit['face']['skin']
// //     //     skin.item = item_equip['face']
// //     //     skin.ctx = ctx['face']
// //     //     skin.onload = function () {
// //     //         drawEMatSkinAnimation(this.ctx, this.item, this, colorSkin, 'face')
// //     //     }
// //     // }
// // }

// // function load_suits(type = 0, domain = 'http://resstagging.gn.zing.vn/image/') {
// //     (type == 0) && suitArr.push(JSON.stringify(suit))
// //     resetCanvas()
// //     var imgSuit = new Image;
// //     imgSuit.src = domain + 'equip/f/suits/' + suit.suits + '/1/show.png'
// //     imgSuit.onload = function() {
// //         draw_suits(ctx.suits, this, 120, 162)
// //     }
// // }

// // function draw_suits(context, img, width, height) {
// //     var count = 0, eClose = 0
// //     suits_run = setInterval(function() {
// //         count++
// //         if (count == 1 || count == 5) {
// //             context.clearRect(0, 0, canvaswidth, canvasHeight)
// //             context.drawImage(img, 0, 0, 255, 342, 23, 41, width, height)
// //         } else if (count == 2 || count == 4) {
// //             context.clearRect(0, 0, canvasWidth, canvasHeight)
// //             context.drawImage(img, 750, 0, 255, 342, 23, 41, width, height)
// //         } else if (count == 3) {
// //             context.clearRect(0, 0, canvasWidth, canvasHeight)
// //             context.drawImage(img, 500, 0, 255, 342, 23, 41, width, height)
// //             eClose++
// //         } else if (count == 6) {
// //             if (eClose == 2) {
// //                 setTimeout(function() {
...
// // /**
// //  * Hàm Reset Canvas. Bao gồm các vòng lặp
// //  * @return none
// //  */
// // function resetCanvas() {
// //     for (var i = 0; i < canvas.length; i++) {
// //         ctx[canvas[i]].clearRect(0, 0, canvasWidth, canvasHeight)
// //     }
// //     clearInterval(eff_run) // xóa Interval Mắt
// //     clearInterval(test) // xóa Interval Mắt có Màu
// //     clearInterval(matSkin) // xóa Intermal Mắt có Skin
...
// 	        //     this.imageloaded.equip[key].onload = function(){
// 	        //         if(this.key == "face") return;
// 	        //         if(!gnAvatarInfo.color[this.key] || !gnAvatarInfo.suit[this.key]){
...
// 	        //                 dy: that.y
// 	        //             });
// 	        //         } else if (this.key in gnAvatarInfo.color && gnAvatarInfo.color[this.key]) {
// 	        //             that.imageloaded.overlay[this.key] = new Image;
// 	        //             that.imageloaded.overlay[this.key].src = that.res[this.key].overlay;
// 	        //             that.imageloaded.overlay[this.key].original = this;
// 	        //             that.imageloaded.overlay[this.key].key = this.key;
...
// 		                		}
// 		                	})
// 		                	// that.imageloaded.overlay[key] = new Image;
// 		                	// that.imageloaded.overlay[key].src = that.res[key].overlay;
// 		                	// that.imageloaded.overlay[key].original = this;
// 		                	// that.imageloaded.overlay[key].onload = function(){
// 	                		// 	gnAvatarDraw.drawStaticObjectColor({
// 	                		// 		overlay: this,
// 	                		// 		original: this.original,
// 	                		// 		...info
...
// 	    		var wingHandle = new gnAvatarWingAnimation();
// 	    		wingHandle.load();
// 	    	}	
// 	    	return this;
// 	    },
...
// 		skinColor: "#7500AB"
// 	}
// 	// gnAvatarInfo.ctx["hair"].clearRect(0,0,1000,1000);
