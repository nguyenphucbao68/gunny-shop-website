...
for (var i = 0; i < canvas.length; i++) {
    ...
    var suitArr = []
    var suitImage = []
    var suitColor = {'face': 0,'hair': 0,'head': 0,'cloth': 0,'glass': 0,'eff': 0}
    var suit = {'face': 0,'hair': 0,'head': 0,'cloth': 0,'glass': 0,'eff': 0,'wing': 0,'suits': 0}
    var count2 = 0
    var posEquip = {
        'head': {
            'x': 0,
...
$(function() {
    ...
    //     } else {
    //         load_shop(settingShop.currentCatId, page, infoCurrent.gt)
    ...
    // function load_shop(catId, page = 1) {
    //     shop.catId = catId;
    //     $('.item-show .show div').gnLoadMainContent("shopMainContent", {
    //         page: page,
    //         info: "disable"
    //     });
